...
2. **Preferences** 클릭
   ...
   <img src="./images/image-20210609195030494.png" alt="image-20210609195030494" style="zoom:50%;" />

3. **SSH Keys**. 클릭

   <img src="./images/image-20210609195122865.png" alt="image-20210609195122865" style="zoom:50%;" />

4. **Key** 박스에 퍼블릭 키 파일의 내용 붙여넣기

   ![image-20210609195224808](./images/image-20210609195224808.png)
...
* https://docs.gitlab.com/ee/ssh/#update-your-ssh-key-passphrase