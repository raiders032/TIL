...
* [Item3 private 생성자나 열거타입으로 싱글턴임을 보증하라](Chapter2/Item3/Item3.md)
* [Item4 인스턴스화를 막으려거든 private 생성자를 사용하라](Chapter2/Item4/Item4.md)
* [Item5 자원을 직접 명시하지 말고 의존 객체 주입을 사용하라](Chapter2/Item5/Item5.md)
* [Item6 불필요한 객체 생성을 피하라](Chapter2/Item6/Item6.md)
* [Item7 다 쓴 객체 참조를 해제하라](Chapter2/Item7/Item7.md)
* [Item8 finalizer와 cleaner 사용을 피하라](Chapter2/Item8/Item8.md)
...
* [Item12 toString을 항상 재정의하라](Chapter3/Item12/Item12.md)
* [Item13 clone 재정의는 주의해서 진행하라](Chapter3/Item13/Item13.md)
* [Item14 Comparable 구현할지 고려하라](Chapter3/Item14/Item14.md)
